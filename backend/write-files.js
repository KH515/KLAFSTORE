...
let products = fs.readFileSync('src/routes/products.js', 'utf8');

// نضيف slug endpoint وتوليد slug تلقائي
const newCode = `export async function handleProducts(request, env, corsHeaders) {
...
fs.writeFileSync('src/routes/products.js', newCode, 'utf8');
console.log('done');